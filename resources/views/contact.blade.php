    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-12 sm:mb-16">
            <div class="text-center p-6 sm:p-8 bg-teal-50 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-fadeInUp delay-100">
                ...
                <h3 class="text-lg sm:text-xl font-bold text-white mb-2 sm:mb-3">{{ $content['address_title'] ?? 'Visit Us' }}</h3>
            ...
            <div class="text-center p-6 sm:p-8 bg-teal-50 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-fadeInUp delay-200">
                ...
                <h3 class="text-lg sm:text-xl font-bold text-white mb-2 sm:mb-3">{{ $content['phone_title'] ?? 'Call Us' }}</h3>
                <p class="text-gray-100 text-sm sm:text-base">
            ...
            <div class="text-center p-6 sm:p-8 bg-teal-50 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-fadeInUp delay-300">
                ...
                <h3 class="text-lg sm:text-xl font-bold text-white mb-2 sm:mb-3">{{ $content['email_title'] ?? 'Email Us' }}</h3>
                <p class="text-gray-100 text-sm sm:text-base">
            ...
            <div class="text-center p-6 sm:p-8 bg-teal-50 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-fadeInUp delay-400">
                ...
                <h3 class="text-lg sm:text-xl font-bold text-white mb-2 sm:mb-3">{{ $content['hours_title'] ?? 'Working Hours' }}</h3>
                <p class="text-gray-100 text-sm sm:text-base">
        ...
        <div class="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div class="animate-fadeInLeft">
                <div class="bg-white p-6 sm:p-8 md:p-10 rounded-2xl shadow-lg">
                    <h2 class="text-2xl sm:text-3xl font-bold text-white mb-4 sm:mb-6">{{ $content['form_title'] ?? 'Send Us a Message' }}</h2>
            ...
            <div class="animate-fadeInRight space-y-6 sm:space-y-8">
                ...
                <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-lg">
                    <h3 class="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6">{{ $content['map_title'] ?? 'Our Location' }}</h3>
                ...
                <!-- Social Media -->
                <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-lg">
                    <h3 class="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6">{{ $content['social_title'] ?? 'Follow Us' }}</h3>
                    <p class="text-gray-100 mb-6 text-sm sm:text-base">{{ $content['social_description'] ?? 'Stay connected with us on social media for updates, news, and special offers.' }}</p>
...
<section class="py-12 sm:py-16 md:py-20 bg-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12 sm:mb-16 animate-fadeInUp">
            <h2 class="text-3xl sm:text-4xl font-bold text-white mb-3 sm:mb-4">{{ $content['faq_title'] ?? 'Frequently Asked Questions' }}</h2>
            <p class="text-gray-100 text-base sm:text-lg max-w-2xl mx-auto px-4">{{ $content['faq_subtitle'] ?? 'Find quick answers to common questions' }}</p>
        </div>
        <div class="max-w-4xl mx-auto space-y-4 sm:space-y-6">
            <div class="bg-teal-50 p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 animate-fadeInUp delay-100">
                <h3 class="text-lg sm:text-xl font-bold text-white mb-3">How can I become a vendor on AlphaVendor?</h3>
                <p class="text-gray-100 text-sm sm:text-base leading-relaxed">To become a vendor, simply register an account and apply for vendor status through your dashboard. Our team will review your application within 24-48 hours.</p>
            </div>
            <div class="bg-teal-50 p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 animate-fadeInUp delay-200">
                <h3 class="text-lg sm:text-xl font-bold text-white mb-3">What are your shipping policies?</h3>
                <p class="text-gray-100 text-sm sm:text-base leading-relaxed">Each vendor sets their own shipping policies. You can find specific shipping information on individual product pages. We support both local and international shipping.</p>
            </div>
            <div class="bg-teal-50 p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 animate-fadeInUp delay-300">
                <h3 class="text-lg sm:text-xl font-bold text-white mb-3">How do I track my order?</h3>
                <p class="text-gray-100 text-sm sm:text-base leading-relaxed">Once your order ships, you'll receive a tracking number via email. You can also track your orders through your account dashboard.</p>
            </div>
            <div class="bg-teal-50 p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 animate-fadeInUp delay-400">
                <h3 class="text-lg sm:text-xl font-bold text-white mb-3">What payment methods do you accept?</h3>
                <p class="text-gray-100 text-sm sm:text-base leading-relaxed">We accept all major credit cards, PayPal, bank transfers, and various other payment methods depending on your region.</p>
            </div>
        </div>
    </div>
</section>
