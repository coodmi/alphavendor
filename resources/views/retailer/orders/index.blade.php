        ...
        <div class="overflow-x-auto">
                ...
                <table class="w-full">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-200 uppercase tracking-wider">My Earning</th>
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-200 mt-2">Orders from your products will appear here</p>
                </div>
            @endif
        </div>
    </div>
