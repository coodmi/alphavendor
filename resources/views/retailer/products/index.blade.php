...
<div class="mb-8">
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-100">Manage your products</p>
        </div>
...
<div id="productModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <form id="productForm" class="p-6 space-y-5">
            ...
            <div>
                <label class="block text-sm font-semibold text-white mb-3">Product Attributes</label>
                <div class="space-y-3 max-h-48 overflow-y-auto border border-gray-200 rounded-lg p-3">
                    @foreach($attributes as $attr)
                    <div class="flex items-center gap-3">
                        <label class="text-sm font-medium text-gray-100 w-28 flex-shrink-0">
                            {{ $attr->name }}
