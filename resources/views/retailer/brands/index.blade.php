...
@section('sidebar-menu')
    <div class="menu-section">
        ...
        <a href="{{ route('retailer.brands') }}" class="menu-item active">
...
function executeSoftDelete() {
    ...
    fetch(`/retailer/brands/${deleteTargetId}`, {
        method: 'DELETE',
        headers: {
...
document.getElementById('brandForm').addEventListener('submit', function(e) {
    ...
    const url = editingBrandId ? `/retailer/brands/${editingBrandId}` : '{{ route('retailer.brands.store') }}';
