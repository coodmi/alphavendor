    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-2">
                <i class="fas fa-shield-alt text-orange-600 mr-3"></i>Privacy Policy Management
            </h1>
            <p class="text-gray-600">Manage the content displayed on your Privacy Policy page</p>
        </div>
        ...
        <!-- Form -->
        <form action="{{ route('admin.page-contents.privacy.update') }}" method="POST" class="bg-white rounded-2xl shadow-xl p-8">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title', $page->title ?? 'Privacy Policy') }}" required
                ...
                <div>
                    ...
                    <textarea name="content" id="privacy-editor" required
                ...
                <div class="flex gap-4 pt-4">
                    ...
                    <a href="{{ route('privacy') }}" target="_blank" class="px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-xl font-bold transition-all">
