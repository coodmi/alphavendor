...
<div class="mb-8">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h2 class="text-2xl font-bold text-white">Homepage Banner Management</h2>
            <p class="text-gray-200 mt-1">Manage promotional banners displayed on the homepage</p>
        </div>
        ...
        <table class="w-full">
            <thead>
                <tr class="bg-gray-50 border-b border-gray-200">
                    ...
                    <th class="px-6 py-4 text-left text-sm font-semibold text-white">Title</th>
                    <th class="px-6 py-4 text-left text-sm font-semibold text-white">Link</th>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-4">
                        <span class="font-medium text-white">{{ $banner->title ?? 'No Title' }}</span>
                    </td>
                    <td class="px-6 py-4">
                        @if($banner->link)
                ...
                <tr>
                    <td colspan="6" class="px-6 py-16 text-center">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-gray-200 text-lg">No banners found</p>
...
<div id="bannerModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-xl w-full max-w-xl max-h-[90vh] overflow-y-auto shadow-2xl">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center sticky top-0 bg-white">
            <h3 class="text-xl font-bold text-white" id="modalTitle">Add Banner</h3>
        ...
        <form id="bannerForm" method="POST" enctype="multipart/form-data" class="p-6">
            ...
            <div class="mb-5">
                <label class="block text-sm font-medium text-white mb-2">Banner Title</label>
            ...
            <div class="mb-5">
                <label class="block text-sm font-medium text-white mb-2">Custom Link URL (Optional)</label>
...
<div id="deleteModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-xl w-full max-w-md shadow-2xl transform transition-all">
        <div class="p-6 text-center">
            ...
            <h3 class="text-xl font-bold text-white mb-2">Delete Banner</h3>
