...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-100">Configure your bKash, Nagad, and Rocket payment numbers</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.payment-settings.update') }}" method="POST">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-pink-50">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-lg font-semibold text-white">bKash</h2>
                                <p class="text-sm text-gray-200">Personal/Agent/Merchant Account</p>
                            </div>
                        </div>
                        <label class="flex items-center cursor-pointer">
                            ...
                            <span class="ms-3 text-sm font-medium text-white">Enabled</span>
                        </label>
                    </div>
                </div>
                <div class="p-6 space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-white mb-1">bKash Number *</label>
                        <div class="relative">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-white mb-1">Account Holder Name</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-white mb-1">Account Type</label>
                    ...
                    @if($settings['bkash_number'])
                        <div class="bg-pink-50 border border-pink-200 rounded-lg p-3">
                            <p class="text-sm text-gray-100">Customers will see:</p>
                            <p class="text-lg font-bold text-pink-600">{{ $settings['bkash_number'] }}</p>
                            @if($settings['bkash_name'])
                                <p class="text-sm text-gray-200">{{ $settings['bkash_name'] }}</p>
                            @endif
                        </div>
                    @endif
                </div>
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200 bg-teal-50">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-lg font-semibold text-white">Nagad</h2>
                                <p class="text-sm text-gray-200">Personal/Agent/Merchant Account</p>
                            </div>
                        </div>
                        <label class="flex items-center cursor-pointer">
                ...
                <div class="p-6 space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-white mb-1">Nagad Number *</label>
                        <div class="relative">
                            <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                    ...
                    @if($settings['nagad_number'])
                        <div class="bg-teal-50 border border-orange-200 rounded-lg p-3">
                            ...
                            @if($settings['nagad_name'])
                                <p class="text-sm text-gray-200">{{ $settings['nagad_name'] }}</p>
                            @endif
                        </div>
                    @endif
                </div>
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden lg:col-span-2">
                <div class="px-6 py-4 border-b border-gray-200 bg-purple-50">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-lg font-semibold text-white">Rocket (DBBL)</h2>
                                <p class="text-sm text-gray-200">Dutch Bangla Mobile Banking</p>
                            </div>
                        </div>
                        <label class="flex items-center cursor-pointer">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-white mb-1">Rocket Number</label>
                            <div class="relative">
                                <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
