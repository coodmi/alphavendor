...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-200 text-sm">Closed</p>
                    <p class="text-2xl font-bold text-gray-100">{{ $stats['closed'] }}</p>
                </div>
                <div class="bg-gray-100 p-3 rounded-full">
                    <i class="fas fa-times-circle text-gray-100 text-xl"></i>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md">
        <div class="p-6 border-b border-gray-200">
            <div class="flex justify-between items-center">
                <h2 class="text-2xl font-bold text-white">All Support Tickets</h2>
        ...
        <div class="p-6 border-b border-gray-200 bg-gray-50">
            <form method="GET" action="{{ route('admin.tickets.index') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('admin.tickets.index') }}" class="px-4 py-2 bg-gray-300 text-white rounded-lg hover:bg-gray-400 transition">
                        Clear
                    </a>
                </div>
            </form>
        ...
        <div class="overflow-x-auto">
                ...
                <table class="w-full">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-200 uppercase tracking-wider">User</th>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-200 uppercase tracking-wider">Assigned To</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($tickets as $ticket)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-white">{{ $ticket->user->name }}</div>
                                    <div class="text-sm text-gray-200">{{ $ticket->user->email }}</div>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm text-white">{{ $ticket->assignedTo->name ?? 'Unassigned' }}</span>
                                </td>
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="text-xl text-gray-100">No tickets found</p>
                </div>
            @endif
        </div>
    </div>
