    ...
    <div class="max-w-6xl mx-auto">
        <div class="bg-white rounded-lg shadow-md mb-6">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="text-sm font-semibold text-gray-100">User</label>
                            <p class="text-white">{{ $ticket->user->name }}</p>
                            <p class="text-sm text-gray-200">{{ $ticket->user->email }}</p>
                        </div>
                        <div>
                            <label class="text-sm font-semibold text-gray-100">Category</label>
                            <p class="text-white">{{ ucfirst($ticket->category) }}</p>
                        </div>
                        <div>
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- Assign -->
                        <div>
                            <label class="text-sm font-semibold text-gray-100">Assign To</label>
        ...
        <div class="bg-white rounded-lg shadow-md mb-6">
            ...
            <div class="p-6 space-y-4 max-h-96 overflow-y-auto">
                ...
                @empty
                    <p class="text-center text-gray-200">No replies yet</p>
                @endforelse
            </div>
        </div>
