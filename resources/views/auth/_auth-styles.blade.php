...
.btn-primary { background: #0d5c63; color: #fff; font-weight:700; }
...
.forgot-link:hover, .forgot-link:focus { color:#0a4a50; text-decoration:underline; }
.forgot-note { color:#777; margin-bottom:12px; }

.auth-link { text-align:center; margin-top:20px; color:#666; }
.auth-link a { color:#0d5c63; text-decoration:none; }
