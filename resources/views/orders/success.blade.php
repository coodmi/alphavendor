...
<div class="container mx-auto px-4 py-12">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-100 mb-4">Thank you for your order. We've received your order and will process it soon.</p>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                    ...
                    <div class="border-b pb-4 mb-4">
                        <div class="flex justify-between items-start">
                            <div>
                                <h2 class="text-xl font-bold text-white">Order #{{ $order->order_number }}</h2>
                                <p class="text-sm text-gray-200 mt-1">Placed on {{ $order->created_at->format('F d, Y \a\t h:i A') }}</p>
                            </div>
                            <div class="text-right">
                                ...
                                <p class="text-sm text-gray-200 mt-1">
                                    ...
                                    @else
                                        <span class="text-gray-100">{{ ucfirst($order->payment_status) }}</span>
                                    @endif
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            <h3 class="font-semibold text-white mb-2">Payment Method</h3>
                            <p class="text-gray-100 text-sm">
                        ...
                        <div class="border rounded-lg overflow-hidden">
                            <table class="min-w-full">
                                <thead class="bg-gray-50">
                                    <tr>
                                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-200 uppercase">Product</th>
                                        <th class="px-4 py-3 text-center text-xs font-medium text-gray-200 uppercase">Quantity</th>
                                        <th class="px-4 py-3 text-right text-xs font-medium text-gray-200 uppercase">Price</th>
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    @foreach($order->items as $item)
                                        <tr>
                                            ...
                                            <td class="px-4 py-3 text-center text-gray-100">{{ $item->quantity }}</td>
                                            <td class="px-4 py-3 text-right text-gray-100">৳{{ number_format($item->price, 2) }}</td>
                                            <td class="px-4 py-3 text-right font-medium text-white">৳{{ number_format($item->subtotal, 2) }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                        ...
                        <div class="flex justify-end">
                            <div class="w-full md:w-1/2">
                                ...
                                @if($order->delivery_charge > 0)
                                    <div class="flex justify-between py-2">
                                        <span class="text-gray-100">Delivery Charge:</span>
                    ...
                    <div class="flex gap-3 mt-6 pt-4 border-t">
                        ...
                        <button onclick="window.print()" class="flex-1 bg-gray-200 text-white px-4 py-2 rounded hover:bg-gray-300">
        ...
        <div class="flex gap-4 justify-center mt-8">
            ...
            <a href="{{ route('shop') }}" class="bg-gray-200 text-white px-6 py-3 rounded hover:bg-gray-300">
