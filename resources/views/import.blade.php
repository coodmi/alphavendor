                    ...
                    <a href="{{ route('product.show', $product->id) }}?quantity={{ $product->minimum_order ?? 1 }}" class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow group block">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-center gap-2 flex-wrap mb-2">
                                <span class="text-lg font-bold text-white">{{ currency_symbol() }}{{ number_format($product->price, 2) }}</span>
                                @if($product->old_price)
                                    <span class="text-sm text-gray-200 line-through">{{ currency_symbol() }}{{ number_format($product->old_price, 2) }}</span>
