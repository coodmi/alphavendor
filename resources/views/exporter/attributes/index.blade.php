...
function openAddModal() {
    ...
    document.getElementById('attributeForm').action = '{{ route("exporter.attributes.store") }}';
...
function openEditModal(attributeId) {
    ...
    document.getElementById('attributeForm').action = `/exporter/attributes/${attributeId}`;
...
function deleteAttribute(attributeId) {
    ...
    form.method = 'POST';
    form.action = `/exporter/attributes/${attributeId}`;
