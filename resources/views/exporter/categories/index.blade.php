...
@section('sidebar-menu')
    <div class="menu-section">
        ...
        <a href="{{ route('exporter.categories') }}" class="menu-item active">
...
<div class="mb-8">
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600">Manage product categories for export</p>
        </div>
...
<div id="deleteModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-xl max-w-md w-full shadow-2xl transform transition-all duration-300">
        <div class="p-6">
            ...
            <h3 class="text-2xl font-bold text-gray-900 text-center mb-2" id="deleteModalTitle">Delete Category?</h3>
