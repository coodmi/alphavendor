...
<div class="mb-8">
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-100">Manage product categories for export</p>
        </div>
            ...
            <tbody id="categoriesTableBody" class="bg-white divide-y divide-gray-200">
                ...
                <tr id="category-row-{{ $category->id }}" class="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                        <button onclick='editCategory(@json($category))' class="inline-flex items-center px-3 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition-colors duration-150 mr-2">
                            <i class="fas fa-edit mr-1"></i> Edit
                        </button>
                        <button onclick="confirmDelete({{ $category->id }}, '{{ $category->name }}')" class="inline-flex items-center px-3 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 transition-colors duration-150">
...
function executeSoftDelete() {
    ...
    fetch(`/exporter/categories/${deleteTargetId}`, {
        method: 'DELETE',
        headers: {
...
document.getElementById('categoryForm').addEventListener('submit', function(e) {
    ...
    const url = editingCategoryId ? `/exporter/categories/${editingCategoryId}` : '{{ route('exporter.categories.store') }}';
