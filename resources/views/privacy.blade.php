            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 md:p-12">
                ...
                <div class="mt-12 p-6 bg-gradient-to-r from-orange-50 to-yellow-50 rounded-xl border-l-4 border-orange-500">
                    <h3 class="text-xl font-bold text-orange-900 mb-3">
                        <i class="fas fa-envelope mr-2 text-orange-600"></i>Privacy Questions or Concerns?
                    </h3>
                    ...
                    <div class="space-y-2 text-gray-700">
                        ...
                        <p><i class="fas fa-envelope text-orange-600 mr-2"></i> <a href="mailto:privacy@armarketbd.com" class="hover:text-orange-600">privacy@armarketbd.com</a></p>
