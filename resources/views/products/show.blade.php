                ...
                <div class="flex flex-col gap-4 py-5">
                    ...
                    <form action="{{ route('cart.add', $product->id) }}" method="POST" id="addToCartForm">
                        ...
                        <div class="flex gap-3 mb-4">
                            <button type="submit" class="flex-1 px-6 py-4 bg-teal-600 text-white rounded-lg text-base font-semibold hover:bg-teal-700 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg flex items-center justify-center gap-2.5">
                                <i class="fas fa-shopping-cart"></i>
                                Add to Cart
                            </button>
                            <button type="button" onclick="buyNow()" class="flex-1 px-6 py-4 bg-gradient-to-r from-teal-700 to-teal-800 text-white rounded-lg text-base font-semibold hover:from-teal-800 hover:to-teal-900 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg flex items-center justify-center gap-2.5">
                    ...
                    <div class="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border-2 border-blue-200">
                        <div class="flex items-center gap-3 mb-3">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-800 text-sm">Advance Payment Option</h4>
                                <p class="text-xs text-gray-600">অ্যাডভান্স পেমেন্ট করে অর্ডার নিশ্চিত করুন</p>
                            </div>
                        </div>
                        <button type="button" onclick="openAdvancePaymentModal()"
                            class="w-full px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-lg font-semibold hover:from-blue-600 hover:to-indigo-700 transition-all duration-300 flex items-center justify-center gap-2 shadow-md hover:shadow-lg">
