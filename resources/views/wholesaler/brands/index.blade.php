...
@section('sidebar-menu')
    <div class="menu-section">
        ...
        <a href="{{ route('wholesaler.brands') }}" class="menu-item active">
...
function executeSoftDelete() {
    ...
    fetch(`/wholesaler/brands/${deleteTargetId}`, {
        method: 'DELETE',
        headers: {
...
document.getElementById('brandForm').addEventListener('submit', function(e) {
    ...
    const url = editingBrandId ? `/wholesaler/brands/${editingBrandId}` : '{{ route('wholesaler.brands.store') }}';
