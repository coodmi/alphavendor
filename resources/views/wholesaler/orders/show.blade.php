...
<div class="container mx-auto px-4 py-8">
    <div class="mb-6 flex items-center justify-between">
        <a href="{{ route('wholesaler.orders') }}" class="text-blue-600 hover:text-blue-800">
            <i class="fas fa-arrow-left mr-2"></i>Back to Orders
        </a>
        <a href="{{ route('wholesaler.orders.invoice', $order) }}" target="_blank"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <form action="{{ route('wholesaler.orders.update-status', $order) }}" method="POST">
                    @csrf
                    @method('PATCH')
