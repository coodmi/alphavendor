...
<div class="mb-8">
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-3xl font-bold text-gray-800 mb-1">Supplier Locations Management</h2>
            <p class="text-gray-600">Manage supplier locations for your products</p>
        </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr id="location-row-{{ $location->id }}" class="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="text-sm text-gray-900">{{ $location->country ?? 'N/A' }}</span>
                    </td>
                    <td class="px-6 py-4">
                        <span class="text-sm text-gray-600">{{ Str::limit($location->description, 50) ?? 'No description' }}</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $location->sort_order }}</td>
                ...
                <tr>
                    <td colspan="6" class="px-6 py-16 text-center">
                        ...
                        <p class="text-gray-500 text-lg">No supplier locations found. Click "Add Supplier Location" to create one.</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
    ...
    <div class="bg-white rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <form id="locationForm" class="p-6 space-y-5">
            ...
            <div class="flex gap-3 pt-4 border-t border-gray-200">
                <button type="button" onclick="closeModal()" class="flex-1 px-6 py-3 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition-colors duration-150 font-semibold">
                    Cancel
                </button>
...
<div id="deleteModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-xl w-full max-w-md shadow-2xl">
        <div class="p-6">
            ...
            <h3 class="text-2xl font-bold text-gray-900 text-center mb-2" id="deleteModalTitle">Delete Supplier Location?</h3>
            <p class="text-gray-600 text-center mb-6" id="deleteModalMessage">Are you sure you want to delete this supplier location?</p>
