    ...
    <div class="dashboard-content">
        ...
        <div class="dashboard-section">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-bold text-gray-800">Export Certifications & Rating</h2>
            ...
            <div class="grid grid-cols-1 gap-6">
                <div class="p-4 bg-gray-50 rounded-lg">
                    <div class="flex justify-between items-center mb-3">
                        ...
                        <a href="{{ route('exporter.certifications') }}" class="text-sm text-indigo-600 hover:text-indigo-800 font-medium">
                    ...
                    <div id="currentCertifications">
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <a href="{{ route('exporter.certifications') }}" class="inline-block px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 text-sm">
                        ...
                        @if(Auth::user()->exporter_rating)
                            ...
                            <div class="flex text-yellow-400 text-xl ml-2">
                                @for($i = 1; $i <= 5; $i++)
                                    ...
                                    @elseif($i - 0.5 <= Auth::user()->exporter_rating)
        ...
        <div class="dashboard-section">
            ...
            <div class="action-buttons">
                <a href="{{ route('exporter.products') }}" class="btn btn-primary">Add Export Product</a>
...
document.getElementById('certificationsForm').addEventListener('submit', function(e) {
    ...
    fetch('{{ route("exporter.certifications.bulk-update") }}', {
        method: 'POST',
        headers: {
